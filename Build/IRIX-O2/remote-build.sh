...
#   AA_O2_PATH   remote directory to sync into (default: ~/aa-o2-build/AAScriptCompiler)
#   AA_O2_PORT   ssh port (default: 22)
#   AA_O2_MAKE   make binary to invoke remotely.
#
# No rsync on this box -- plain tar-over-ssh instead (see AmuletsArmor's
# Build/IRIX-O2/remote-build.sh for why).
...
REMOTE_PATH="${AA_O2_PATH:-~/aa-o2-build/AAScriptCompiler}"
...
echo "==> Done. Binary at $REMOTE_PATH/Build/IRIX-O2/build/AAScriptCompiler on $AA_O2_HOST"
