...
# G3/Panther platform there (Apple gcc 4.0 + 10.3.9 SDK; see the Makefile).
# The Tiger box is the build host because it carries the 10.3.9 SDK and the
# Apple compilers; the *output* targets Panther/G3.
#
# Usage:
...
#                 (default: ~/aa-ppc-g3-build/AAScriptCompiler)
...
REMOTE_PATH="${AA_PPC_PATH:-~/aa-ppc-g3-build/AAScriptCompiler}"
...
echo "==> Done. Binary at $REMOTE_PATH/Build/MacOSX-PPC-G3/build/AAScriptCompiler on $AA_PPC_HOST"
