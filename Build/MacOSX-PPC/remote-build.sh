...
#                 (default: ~/aa-ppc-build/AAScriptCompiler)
...
REMOTE_PATH="${AA_PPC_PATH:-~/aa-ppc-build/AAScriptCompiler}"
...
echo "==> Done. Binary at $REMOTE_PATH/Build/MacOSX-PPC/build/AAScriptCompiler on $AA_PPC_HOST"
